...
def main():
    nodelist = ['benefits/development/energy', 'benefits/development/roads', 'benefits/jobs',
    'controversies/china/border', 'controversies/china/uighur', 'controversies/pakistan/bajwa',
    'controversies/pakistan/baloch', 'controversies/pakistan/students', 'leadership/bajwa',
    'leadership/sharif', 'opposition/propaganda', 'benefits/connections/afghanistan', 'benefits/covid',
    'benefits/development/maritime', 'controversies/china/debt', 'controversies/china/exploitation',
    'controversies/china/funding', 'controversies/china/naval', 'controversies/pakistan/army',
    'leadership/khan', 'opposition/kashmir', 'empty']
    ...
    for key in nodelist:
        ...
        yt5[key] = {}
        # if key == 'empty':
        #     with open('./data_json/twitter_time_series_to_6_29.json', 'r') as f:
	    #         d = json.loads(f.read())
        #     d = {k: pd.read_json(v, typ='series') for k, v in d.items()}
        #     empty_df1 = d['empty']['EventCount']
        #     res = int(np.mean(list(empty_df1.values())))
        #     sdate = 1593475200000
        #     tt10[key]["EventCount"] = {}
        #     tt5[key]["EventCount"] = {}
        #     tt[key]["EventCount"] = {}
        ...
        #     tt[key]["NewUserCount"] = {}
        #     for i in range(28):
        #         tt[key]["EventCount"][str(sdate + i * 86400000)] = res
        #         tt10[key]["EventCount"][str(sdate + i * 86400000)] = res
        #         tt5[key]["EventCount"][str(sdate + i * 86400000)] = res
        #     empty_df2 = d['empty']['UserCount']
        #     res = int(np.mean(list(empty_df2.values())))
        #     for i in range(28):
        #         tt10[key]["UserCount"][str(sdate + i * 86400000)] = res
        #         tt5[key]["UserCount"][str(sdate + i * 86400000)] = res
        #         tt[key]["UserCount"][str(sdate + i * 86400000)] = res
        #     empty_df3 = d['empty']['NewUserCount']
        #     res = int(np.mean(list(empty_df3.values())))
        #     for i in range(28):
        #         tt10[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        #         tt5[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        #         tt[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        #     with open('./data_json/youtube_time_series_to_6_29.json', 'r') as f:
	    #         d = json.loads(f.read())
        #     d = {k: pd.read_json(v, typ='series') for k, v in d.items()}
        #     empty_df1 = d['empty']['EventCount']
        #     res = int(np.mean(list(empty_df1.values())))
        ...
        #     yt[key]["NewUserCount"] = {}
        #     for i in range(28):
        #         yt[key]["EventCount"][str(sdate + i * 86400000)] = res
        #         yt10[key]["EventCount"][str(sdate + i * 86400000)] = res
        #         yt5[key]["EventCount"][str(sdate + i * 86400000)] = res
        #     empty_df2 = d['empty']['UserCount']
        #     res = int(np.mean(list(empty_df2.values())))
        #     for i in range(28):
        #         yt10[key]["UserCount"][str(sdate + i * 86400000)] = res
        #         yt5[key]["UserCount"][str(sdate + i * 86400000)] = res
        #         yt[key]["UserCount"][str(sdate + i * 86400000)] = res
        #     empty_df3 = d['empty']['NewUserCount']
        #     res = int(np.mean(list(empty_df3.values())))
        #     for i in range(28):
        #         yt10[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        #         yt5[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        #         yt[key]["NewUserCount"][str(sdate + i * 86400000)] = res
        ...
        for target in targets:
            name = key.replace('/','#')
            fname = name + "_original_706_train.csv"
            ...
            sdate = 1591660800000#6-9#1594080000000# 3-22 1552608000000 #3-15 1552003200000 # 3-8 1551398400000 #3-1 #1550188800000# 2-14 #1549584000000
    ...
    #print("rmse:",  error[0])
    #print("ape:", error[1])
    with open('youtube_UIUC_ANOVA_top10_dryrun.json', 'w') as outfile:
        json.dump(yt10, outfile)
    with open('twitter_UIUC_ML_LASSO_2_CORR_STR_MATCH.json', 'w') as outfile:
        json.dump(tt10, outfile)
    with open('youtube_UIUC_ANOVA_top5_dryrun.json', 'w') as outfile:
        json.dump(yt5, outfile)
    with open('twitter_UIUC_ANOVA_top5_dryrun.json', 'w') as outfile:
        json.dump(tt5, outfile)
    with open('youtube_UIUC_ANOVA_avg_dryrun.json', 'w') as outfile:
        json.dump(yt, outfile)
    with open('twitter_UIUC_ANOVA_avg_dryrun.json', 'w') as outfile:
...
def plot_model_tree_fit(model, X, y, name,  target, error):
        ...
        bag = 20
        placeholder = []
        data_csv_data_filename = os.path.join(target, name+"_original_706_test.csv")
