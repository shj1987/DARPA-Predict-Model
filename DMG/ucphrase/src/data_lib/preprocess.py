...
class Preprocessor:
    ...
    def __init__(
        ...
        self.dir_preprocess = utils.IO.mkdir(self.dir_corpus / f'preprocess-{consts.LM_NAME_SUFFIX}')
    ...
    def tokenize_corpus(self):
        ...
        doc_tuples = list(tqdm(pool_func, total=len(docs), ncols=100, desc=f'[Tokenize] {self.path_corpus.stem}'))
        # doc_tuples = [Preprocessor._par_tokenize_doc(doc) for doc in tqdm(docs, ncols=100, desc=f'[Tokenize]')]
