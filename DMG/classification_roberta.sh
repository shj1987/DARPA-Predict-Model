...
python roberta/postprocess.py --path_raw_gz ${path_input_json} --path_id2url ${path_output_id2url} --path_roberta_output ${path_output_csv} --path_roberta_url2prob ${path_output_append}